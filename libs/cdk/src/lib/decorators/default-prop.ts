...
import { MwcBooleanHandler } from '../types'
 ...
 */
export function DefaultProp<T extends object, K extends keyof T>(
  assertion?: MwcBooleanHandler<T[K]>,
  ...args: any[]
): PropertyDecorator {
  return (target, key) => {
    ...
    Object.defineProperty(target, key, {
      get(): undefined {
        mwcAssert.assert(false, errorGetDefaultMessage)
      ...
      set(this: T, initialValue: T[K]) {
        ...
        mwcAssert.assert(isValid, errorMessage)
